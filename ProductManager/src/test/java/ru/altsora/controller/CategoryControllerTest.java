...
import static ru.altsora.handler.AwesomeExceptionHandler.NOT_FOUND_CODE;
...
class CategoryControllerTest extends AbstractWebController {
    ...
    void findById_notFound() throws Exception {
        ...
        mockMvc.perform(get("/item/category/{id}", id))
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath(RET_CODE, Matchers.is(NOT_FOUND_CODE)))
                .andExpect(jsonPath(RET_MESSAGE, Matchers.is(ex.getMessage())))
        ;
    }
}